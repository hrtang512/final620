...
ggplot(dat_us, aes(x = date)) +
  ...
  scale_color_manual(values = c("Cases" = "blue", "Hospitalizations" = "orange", "Deaths" = "black")) +
  scale_fill_brewer(name = "Wave Start Date") +
  labs(
    title = "COVID-19 Death Waves with Standardized Smoothed Trends",
    x = "Date",
...
ggplot(dat_wave2, aes(x = vax_rate, y = mean_death_rate, label = state, color = region)) +
  ...
  labs(
    title = "Series Uptake vs. Average Death Rate in Wave 3",
